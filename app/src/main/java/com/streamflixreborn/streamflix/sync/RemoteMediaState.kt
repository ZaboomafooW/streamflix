...
data class RemoteMediaState(
    ...
    @EncodeDefault @SerialName("tmdb_id") val tmdbId: Int? = null,
    @EncodeDefault @SerialName("imdb_id") val imdbId: String? = null,
    @EncodeDefault @SerialName("parent_show_id") val parentShowId: String? = null,
    @EncodeDefault @SerialName("parent_show_tmdb_id") val parentShowTmdbId: Int? = null,
    @EncodeDefault @SerialName("parent_show_imdb_id") val parentShowImdbId: String? = null,
    ...
    companion object {
        ...
        fun fromEpisode(userId: String, provider: String, episode: Episode, now: Long) =
            RemoteMediaState(
                ...
                parentShowTmdbId = episode.tvShow?.tmdbId,
                parentShowImdbId = episode.tvShow?.imdbId,
